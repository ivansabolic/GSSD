...
class BaseExperiment(object):
    ...
    def __init__(self, model, optimizer, scheduler_iter, scheduler_epoch,
        ...
        if not hasattr(self, 'check_path'):
    ...
    def create_folders(self):
        ...
        if os.path.exists(self.log_path):
            warnings.warn(f"Log folder {self.log_path} already exists, overwriting.")
    ...
    def checkpoint_save(self):
        ...
        torch.save(checkpoint, os.path.join(self.check_path, f'checkpoint.pt'))
